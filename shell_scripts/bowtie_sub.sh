...
cd /home/mz00685/mice_alignment/ #${sample}
...
if [ "$#" -gt 0 ]
  then
      ...
      bowtie2 -p ${cores} --no-unal --very-sensitive -x /home/mz00685/mice_alignment/mm9_genome.fa \
      -1 ${read1_list} \
      -2 ${read2_list} \
      ...
      --rg PL:ILLUMINA \
      --rg LB:${runNum} \
      -S /home/mz00685/mice_alignment/sam/${sample}.sam \
...
cd /home/mz00685/mice_alignment/sam
